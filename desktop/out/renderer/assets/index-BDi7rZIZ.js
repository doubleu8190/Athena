...
function Sidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-64 flex-shrink-0 bg-athena-surface border-r border-athena-border flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-athena-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-6 h-6 text-athena-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-lg", children: "Athena" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: sessions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center text-athena-muted text-sm", children: "No sessions yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "py-2", children: sessions.map((session) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `group flex items-center gap-2 px-3 py-2 mx-2 rounded-lg cursor-pointer transition-colors ${activeSessionId === session.id ? "bg-athena-accent/20 text-athena-text" : "hover:bg-athena-bg text-athena-muted hover:text-athena-text"}`,
        onClick: () => onSelectSession(session.id),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-4 h-4 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 truncate text-sm", children: session.title || "Untitled" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-t border-athena-border text-xs text-athena-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      sessions.length,
      " session",
      sessions.length !== 1 ? "s" : ""
    ] }) })
...
function ToolCard({ toolCall, compact = false }) {
  const { tool_name, arguments: args, status, output, error, duration_ms, risk_level } = toolCall;
  const statusIcon = () => {
    switch (status) {
      case "success":
      ...
      case "denied":
      case "timeout":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-4 h-4 text-athena-warning" });
      case "running":
      default:
  ...
  const riskBadge = () => {
    const className = risk_level === "high" ? "risk-high" : risk_level === "medium" ? "risk-medium" : "risk-low";
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `risk-badge ${className}`, children: risk_level.toUpperCase() });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `card overflow-hidden transition-all ${status === "running" ? "border-athena-accent/50" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 bg-athena-bg/50 border-b border-athena-border", children: [
          statusIcon(),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm font-medium", children: tool_name }),
          riskBadge(),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-xs text-athena-muted flex items-center gap-1", children: [
            statusLabel(),
            duration_ms != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
              (duration_ms / 1e3).toFixed(1),
              "s"
            ] })
          ] })
        ] }),
        !compact && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 space-y-2", children: [
          args && Object.keys(args).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "cursor-pointer text-xs text-athena-muted hover:text-athena-text select-none", children: [
              "Arguments (",
              Object.keys(args).length,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-2 text-xs bg-athena-bg rounded p-2 overflow-x-auto text-athena-text/80", children: JSON.stringify(args, null, 2) })
          ] }),
          output && status === "success" && /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "cursor-pointer text-xs text-athena-muted hover:text-athena-text select-none", children: "Output" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-2 text-xs bg-athena-bg rounded p-2 overflow-x-auto text-athena-text/80 max-h-48 overflow-y-auto", children: output.length > 1e3 ? output.slice(0, 1e3) + "..." : output })
          ] }),
          error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-athena-danger bg-red-500/10 rounded p-2", children: error })
        ] })
      ]
    }
  );
...
const useChatStore = create((set) => ({
  ...
  resolveApproval: (approvalId, _decision) => set((state) => ({
...
function MessageBubble({ message, isStreaming }) {
  ...
  const relatedToolCalls = isUser ? [] : toolCalls.filter((tc) => {
  ...
  if (isSystem) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1 rounded-full bg-athena-surface border border-athena-border text-xs text-athena-muted", children: message.content }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${isUser ? "bg-athena-accent text-white" : isTool ? "bg-yellow-500/20 text-yellow-400" : "bg-athena-surface text-athena-accent border border-athena-border"}`,
            children: isUser ? /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4" }) : isTool ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-4 h-4" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              relatedToolCalls.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 w-full", children: relatedToolCalls.map((tc) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToolCard, { toolCall: tc }, tc.id)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `rounded-2xl px-4 py-3 ${isUser ? "bg-athena-accent text-white rounded-tr-sm" : isTool ? "bg-yellow-500/10 border border-yellow-500/30 rounded-tl-sm" : "bg-athena-surface border border-athena-border rounded-tl-sm"}`,
                  children: isTool ? /* @__PURE__ */ jsxRuntimeExports.jsx(ToolMessageContent, { content: message.content, toolName: message.tool_name }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `prose prose-invert max-w-none text-sm ${isStreaming ? "typing-cursor" : ""}`,
...
function ToolMessageContent({
  ...
  try {
    parsedContent = JSON.parse(content2);
  } catch {
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
    toolName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2 text-yellow-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "w-3 h-3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs", children: toolName })
    ] }),
...
function ApprovalDialog({
  ...
  const [remaining, setRemaining] = reactExports.useState(timeout);
  ...
  const riskColor = risk_level === "high" ? "text-red-400 bg-red-500/20 border-red-500/50" : risk_level === "medium" ? "text-yellow-400 bg-yellow-500/20 border-yellow-500/50" : "text-green-400 bg-green-500/20 border-green-500/50";
  const urgencyClass = remaining <= 10 ? "animate-pulse" : remaining <= 30 ? "animate-pulse-slow" : "";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `card w-full max-w-md shadow-2xl animate-slide-up ${urgencyClass}`,
      onClick: (e) => e.stopPropagation(),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-athena-border flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2 rounded-lg ${riskColor} border`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-5 h-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-athena-muted", children: "This action requires your confirmation" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-athena-muted", children: "Tool:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-athena-bg px-2 py-0.5 rounded text-athena-accent", children: tool_name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-2 text-xs bg-athena-bg rounded p-3 overflow-x-auto text-athena-text/90 max-h-48 overflow-y-auto", children: JSON.stringify(args, null, 2) })
          ] }),
          request.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-athena-text/80 bg-athena-bg/50 rounded p-2", children: request.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-athena-muted", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: remaining <= 10 ? "text-athena-danger font-medium" : "",
                children: [
                  "Timeout in ",
                  remaining,
                  "s"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-t border-athena-border flex gap-2 justify-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onDeny, className: "btn-secondary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }),
            "Deny"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onApprove, className: "btn-primary", children: [
...
class ApiClient {
  ...
  async getMessages(sessionId, limit) {
    ...
    return this.request(`/api/sessions/${sessionId}/messages${params}`);
  }
  async getSteps(sessionId) {
    return this.request(`/api/sessions/${sessionId}/steps`);
  }
  async getToolCalls(sessionId, status) {
    const params = status ? `?status=${status}` : "";
    return this.request(`/api/sessions/${sessionId}/tool_calls${params}`);
  }
  ...
  async cancelApproval(approvalId) {
    return this.request(`/api/approvals/${approvalId}/cancel`, {
      method: "POST"
    });
  }
  async getApprovalLogs(sessionId) {
    return this.request(`/api/approvals/logs/${sessionId}`);
  }
}
...
function Chat({ sendEvent }) {
  ...
  const handleSend = reactExports.useCallback(async () => {
    ...
    if (!text2 || !activeSessionId || isSending) return;
    setIsSending(true);
    setInput("");
    const userMsg = {
  ...
  const handleApproval = reactExports.useCallback(
    (approval, action) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-6 space-y-4", children: [
      ...
      !isLoadingHistory && thinking?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card px-4 py-3 max-w-[85%]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "thinking-indicator", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-athena-muted", children: "Thinking…" })
          ] }),
      ...
      !isLoadingHistory && isAgentActive && !thinking && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "thinking-indicator", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", children: agentStatus === "waiting_approval" ? "Waiting for approval…" : "Processing…" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: messagesEndRef })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-athena-border bg-athena-surface p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            placeholder: activeSessionId ? "Send a message to Athena… (Enter to send, Shift+Enter for newline)" : "Select or create a session to start chatting",
        ...
        isAgentActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleStop,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-athena-muted mt-2 text-center", children: "Athena may produce incorrect information. Verify important details." })
    ] }) }),
    pendingApprovals.map((approval) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ApprovalDialog,
      {
        request: approval,
...
function StatusIndicator() {
  ...
  const connectionIcon = () => {
    switch (connectionStatus) {
      case "connected":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "w-4 h-4 text-athena-success" });
      case "connecting":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 text-yellow-400 animate-spin" });
      case "error":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 text-athena-danger" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "w-4 h-4 text-athena-muted" });
    }
  };
  ...
  const agentBadge = () => {
    switch (agentStatus) {
      case "thinking":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-sm text-yellow-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: "w-4 h-4 animate-pulse" }),
          "Thinking"
        ] });
      case "running":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-sm text-athena-accent", children: [
      ...
      case "error":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-sm text-athena-danger", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4" }),
          "Error"
        ] });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center gap-1.5 text-sm text-athena-muted", children: "Idle" });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-10 px-4 border-b border-athena-border bg-athena-surface flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      agentBadge(),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-athena-danger bg-red-500/10 px-2 py-0.5 rounded", children: error })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-athena-muted", children: [
      connectionIcon(),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: connectionText() })
    ] })
  ] });
}
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full p-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-red-500/20 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-8 h-8 text-athena-danger" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-2 text-athena-text", children: "Something went wrong" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-athena-muted text-sm mb-6 max-w-md", children: this.state.error?.message || "An unexpected error occurred." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: this.handleReset, className: "btn-primary", children: [
...
function useWebSocket(options) {
  ...
  const buildingMessageId = reactExports.useRef(null);
  const {
    setConnectionStatus,
    setAgentStatus,
    addMessage,
  ...
  const buildWsUrl = reactExports.useCallback(
    (sid) => {
  ...
  const sendEvent = reactExports.useCallback(
    (type, data = {}) => {
      if (wsRef.current?.readyState === WebSocket.OPEN) {
    ...
    (event) => {
      ...
      switch (type) {
        ...
        case EventType.APPROVAL_RESULT: {
          ...
          if (approvalId) {
            resolveApproval(approvalId, data.decision);
          }
          setAgentStatus("running");
          break;
        }
...
function AppContent() {
  ...
  const [apiBase, setApiBase] = reactExports.useState("http://127.0.0.1:8000");
  reactExports.useEffect(() => {
    const initApi = async () => {
      if (window.athena) {
  ...
  reactExports.useEffect(() => {
    const loadSessions = async () => {
      try {
        const list2 = await apiClient.listSessions();
        list2.forEach((s) => addSession(s));
      } catch {
      }
    };
    loadSessions();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-screen overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sidebar,
      {
        sessions,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusIndicator, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chat, { sendEvent }, activeSessionId ?? "new")
    ] })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) });
}
