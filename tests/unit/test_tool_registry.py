...
class TestToolRegistry:
    ...
    async def test_register_tools(self, registry, sample_tools):
        ...
        ids = await registry.register("builtin-core", sample_tools, "builtin")
        assert len(ids) == 4
    ...
    async def test_mark_stale(self, registry, sample_tools):
        ...
        await registry.register("builtin-core", sample_tools, "builtin")
    ...
    async def test_fallback_prefers_lower_risk(self, registry):
        ...
        await registry.register("srv1", tools, "external")
    ...
    def test_export_for_planner(self, registry, sample_tools):
        ...
        import asyncio
        asyncio.run(registry.register("builtin-core", sample_tools, "builtin"))
